...
use cw721::{Cw721Execute, Cw721ReceiveMsg, Expiration};
use url::Url;
...
use crate::state::{
    NFTContract, Approval, CollectionInfo, ModelInfo, RoyaltyInfo, TokenInfo,
    COLLECTION_INFO,
};
...
impl<'a, T, C> Cw721Execute<T, C> for NFTContract<'a, T, C>
where
    T: Serialize + DeserializeOwned + Clone,
    C: CustomMsg,
{
